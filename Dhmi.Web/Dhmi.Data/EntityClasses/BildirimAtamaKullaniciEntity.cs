...
namespace dhmi.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'BildirimAtamaKullanici'. <br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class BildirimAtamaKullaniciEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static BildirimAtamaKullaniciEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary>CTor</summary>
		public BildirimAtamaKullaniciEntity() :base("BildirimAtamaKullaniciEntity")
		{
			InitClassEmpty(null);
		}
		
		/// <summary>CTor</summary>
		/// <param name="bildirimAtamaKullaniciId">PK value for BildirimAtamaKullanici which data should be fetched into this BildirimAtamaKullanici object</param>
		public BildirimAtamaKullaniciEntity(System.Int64 bildirimAtamaKullaniciId):base("BildirimAtamaKullaniciEntity")
		{
			InitClassFetch(bildirimAtamaKullaniciId, null, null);
		}

		/// <summary>CTor</summary>
		/// <param name="bildirimAtamaKullaniciId">PK value for BildirimAtamaKullanici which data should be fetched into this BildirimAtamaKullanici object</param>
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		public BildirimAtamaKullaniciEntity(System.Int64 bildirimAtamaKullaniciId, IPrefetchPath prefetchPathToUse):base("BildirimAtamaKullaniciEntity")
		{
			InitClassFetch(bildirimAtamaKullaniciId, null, prefetchPathToUse);
		}

		/// <summary>CTor</summary>
		/// <param name="bildirimAtamaKullaniciId">PK value for BildirimAtamaKullanici which data should be fetched into this BildirimAtamaKullanici object</param>
		/// <param name="validator">The custom validator object for this BildirimAtamaKullaniciEntity</param>
		public BildirimAtamaKullaniciEntity(System.Int64 bildirimAtamaKullaniciId, IValidator validator):base("BildirimAtamaKullaniciEntity")
		{
			InitClassFetch(bildirimAtamaKullaniciId, validator, null);
		}

		/// <summary>Private CTor for deserialization</summary>
		/// <param name="info"></param>
		/// <param name="context"></param>
		protected BildirimAtamaKullaniciEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((BildirimAtamaKullaniciFieldIndex)fieldIndex)
			{
				case BildirimAtamaKullaniciFieldIndex.FkBildirimId:
					DesetupSyncBildirim(true, false);
					_alreadyFetchedBildirim = false;
					break;
				case BildirimAtamaKullaniciFieldIndex.FkKullaniciId:
		...
		public bool FetchUsingPK(System.Int64 bildirimAtamaKullaniciId)
		{
			return FetchUsingPK(bildirimAtamaKullaniciId, null, null, null);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int64 bildirimAtamaKullaniciId, IPrefetchPath prefetchPathToUse)
		{
			return FetchUsingPK(bildirimAtamaKullaniciId, prefetchPathToUse, null, null);
		}
		...
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int64 bildirimAtamaKullaniciId, IPrefetchPath prefetchPathToUse, Context contextToUse)
		{
			return FetchUsingPK(bildirimAtamaKullaniciId, prefetchPathToUse, contextToUse, null);
		}
		...
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int64 bildirimAtamaKullaniciId, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			return Fetch(bildirimAtamaKullaniciId, prefetchPathToUse, contextToUse, excludedIncludedFields);
		}
		...
		{
			return Fetch(this.BildirimAtamaKullaniciId, null, null, null);
		}
		...
		{
			return new BildirimAtamaKullaniciRelations().GetAllRelations();
		}
		...
		/// <param name="bildirimAtamaKullaniciId">PK value for BildirimAtamaKullanici which data should be fetched into this BildirimAtamaKullanici object</param>
		/// <param name="validator">The validator object for this BildirimAtamaKullaniciEntity</param>
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		private void InitClassFetch(System.Int64 bildirimAtamaKullaniciId, IValidator validator, IPrefetchPath prefetchPathToUse)
		{
			OnInitializing();
			this.Validator = validator;
			this.Fields = CreateFields();
			InitClassMembers();	
			Fetch(bildirimAtamaKullaniciId, prefetchPathToUse, null, null);
		...
		{
			this.PerformDesetupSyncRelatedEntity( _bildirim, new PropertyChangedEventHandler( OnBildirimPropertyChanged ), "Bildirim", dhmi.RelationClasses.StaticBildirimAtamaKullaniciRelations.BildirimEntityUsingFkBildirimIdStatic, true, signalRelatedEntity, "BildirimAtamaKullanicis", resetFKFields, new int[] { (int)BildirimAtamaKullaniciFieldIndex.FkBildirimId } );		
			_bildirim = null;
		}
		...
		private void SetupSyncBildirim(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _bildirim, new PropertyChangedEventHandler( OnBildirimPropertyChanged ), "Bildirim", dhmi.RelationClasses.StaticBildirimAtamaKullaniciRelations.BildirimEntityUsingFkBildirimIdStatic, true, ref _alreadyFetchedBildirim, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _kullanici, new PropertyChangedEventHandler( OnKullaniciPropertyChanged ), "Kullanici", dhmi.RelationClasses.StaticBildirimAtamaKullaniciRelations.KullaniciEntityUsingFkKullaniciIdStatic, true, signalRelatedEntity, "BildirimAtamaKullanicis", resetFKFields, new int[] { (int)BildirimAtamaKullaniciFieldIndex.FkKullaniciId } );		
			_kullanici = null;
		}
		...
		private void SetupSyncKullanici(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _kullanici, new PropertyChangedEventHandler( OnKullaniciPropertyChanged ), "Kullanici", dhmi.RelationClasses.StaticBildirimAtamaKullaniciRelations.KullaniciEntityUsingFkKullaniciIdStatic, true, ref _alreadyFetchedKullanici, new string[] {  } );
			}
		}
		...
		/// is set to false, the fields contained in excludedIncludedFields are kept in the query, the rest of the fields in the query are excluded.</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		private bool Fetch(System.Int64 bildirimAtamaKullaniciId, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			try
			{
				OnFetch();
				this.Fields[(int)BildirimAtamaKullaniciFieldIndex.BildirimAtamaKullaniciId].ForcedCurrentValueWrite(bildirimAtamaKullaniciId);
		...
		{
			return new BildirimAtamaKullaniciEntityFactory();
		}

		#region Class Property Declarations
		/// <summary> The relations object holding all relations of this entity with other entity classes.</summary>
		public  static BildirimAtamaKullaniciRelations Relations
		{
			get	{ return new BildirimAtamaKullaniciRelations(); }
		}
		...
		{
			get	{ return new PrefetchPathElement(new dhmi.CollectionClasses.BildirimCollection(), (IEntityRelation)GetRelationsForField("Bildirim")[0], (int)dhmi.EntityType.BildirimAtamaKullaniciEntity, (int)dhmi.EntityType.BildirimEntity, 0, null, null, null, "Bildirim", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement(new dhmi.CollectionClasses.KullaniciCollection(), (IEntityRelation)GetRelationsForField("Kullanici")[0], (int)dhmi.EntityType.BildirimAtamaKullaniciEntity, (int)dhmi.EntityType.KullaniciEntity, 0, null, null, null, "Kullanici", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The BildirimAtamaKullaniciBittiMi property of the Entity BildirimAtamaKullanici<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Bildirim_Atama_Kullanici"."Bildirim_Atama_Kullanici_Bitti_Mi"<br/>
		/// Table field type characteristics (type, precision, scale, length): Bit, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Boolean BildirimAtamaKullaniciBittiMi
		{
			get { return (System.Boolean)GetValue((int)BildirimAtamaKullaniciFieldIndex.BildirimAtamaKullaniciBittiMi, true); }
			set	{ SetValue((int)BildirimAtamaKullaniciFieldIndex.BildirimAtamaKullaniciBittiMi, value, true); }
		}

		/// <summary> The BildirimAtamaKullaniciBittiTarih property of the Entity BildirimAtamaKullanici<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Bildirim_Atama_Kullanici"."Bildirim_Atama_Kullanici_Bitti_Tarih"<br/>
		/// Table field type characteristics (type, precision, scale, length): SmallDateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual Nullable<System.DateTime> BildirimAtamaKullaniciBittiTarih
		{
			get { return (Nullable<System.DateTime>)GetValue((int)BildirimAtamaKullaniciFieldIndex.BildirimAtamaKullaniciBittiTarih, false); }
			set	{ SetValue((int)BildirimAtamaKullaniciFieldIndex.BildirimAtamaKullaniciBittiTarih, value, true); }
		}

		/// <summary> The BildirimAtamaKullaniciId property of the Entity BildirimAtamaKullanici<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Bildirim_Atama_Kullanici"."Bildirim_Atama_Kullanici_ID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int64 BildirimAtamaKullaniciId
		{
			get { return (System.Int64)GetValue((int)BildirimAtamaKullaniciFieldIndex.BildirimAtamaKullaniciId, true); }
			set	{ SetValue((int)BildirimAtamaKullaniciFieldIndex.BildirimAtamaKullaniciId, value, true); }
		}

		/// <summary> The BildirimAtamaKullaniciTarih property of the Entity BildirimAtamaKullanici<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Bildirim_Atama_Kullanici"."Bildirim_Atama_Kullanici_Tarih"<br/>
		/// Table field type characteristics (type, precision, scale, length): SmallDateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.DateTime BildirimAtamaKullaniciTarih
		{
			get { return (System.DateTime)GetValue((int)BildirimAtamaKullaniciFieldIndex.BildirimAtamaKullaniciTarih, true); }
			set	{ SetValue((int)BildirimAtamaKullaniciFieldIndex.BildirimAtamaKullaniciTarih, value, true); }
		}

		/// <summary> The BildirimAtamaKullaniciYonMu property of the Entity BildirimAtamaKullanici<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Bildirim_Atama_Kullanici"."Bildirim_Atama_Kullanici_Yon_mu"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 10<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): true, false, false</remarks>
		public virtual System.String BildirimAtamaKullaniciYonMu
		{
			get { return (System.String)GetValue((int)BildirimAtamaKullaniciFieldIndex.BildirimAtamaKullaniciYonMu, true); }
			set	{ SetValue((int)BildirimAtamaKullaniciFieldIndex.BildirimAtamaKullaniciYonMu, value, true); }
		}

		/// <summary> The FkBildirimId property of the Entity BildirimAtamaKullanici<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Bildirim_Atama_Kullanici"."FK_Bildirim_ID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int64 FkBildirimId
		{
			get { return (System.Int64)GetValue((int)BildirimAtamaKullaniciFieldIndex.FkBildirimId, true); }
			set	{ SetValue((int)BildirimAtamaKullaniciFieldIndex.FkBildirimId, value, true); }
		}

		/// <summary> The FkKullaniciId property of the Entity BildirimAtamaKullanici<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Bildirim_Atama_Kullanici"."FK_Kullanici_ID"<br/>
		/// Table field type characteristics (type, precision, scale, length): SmallInt, 5, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int16 FkKullaniciId
		{
			get { return (System.Int16)GetValue((int)BildirimAtamaKullaniciFieldIndex.FkKullaniciId, true); }
			set	{ SetValue((int)BildirimAtamaKullaniciFieldIndex.FkKullaniciId, value, true); }
		}
		...
		public virtual BildirimEntity Bildirim
		{
			...
			{ 
				...
				{
					SetSingleRelatedEntityNavigator(value, "BildirimAtamaKullanicis", "Bildirim", _bildirim, true); 
				}
			}
		}
		...
		public virtual KullaniciEntity Kullanici
		{
			...
			{ 
				...
				{
					SetSingleRelatedEntityNavigator(value, "BildirimAtamaKullanicis", "Kullanici", _kullanici, true); 
				}
			}
		}
		...
		{ 
			get { return (int)dhmi.EntityType.BildirimAtamaKullaniciEntity; }
		}
