...
namespace dhmi.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'CagriTipi'. <br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class CagriTipiEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static CagriTipiEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary>CTor</summary>
		public CagriTipiEntity() :base("CagriTipiEntity")
		{
			InitClassEmpty(null);
		}
		
		/// <summary>CTor</summary>
		/// <param name="cagriTipiId">PK value for CagriTipi which data should be fetched into this CagriTipi object</param>
		public CagriTipiEntity(System.Int16 cagriTipiId):base("CagriTipiEntity")
		{
			InitClassFetch(cagriTipiId, null, null);
		}

		/// <summary>CTor</summary>
		/// <param name="cagriTipiId">PK value for CagriTipi which data should be fetched into this CagriTipi object</param>
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		public CagriTipiEntity(System.Int16 cagriTipiId, IPrefetchPath prefetchPathToUse):base("CagriTipiEntity")
		{
			InitClassFetch(cagriTipiId, null, prefetchPathToUse);
		}

		/// <summary>CTor</summary>
		/// <param name="cagriTipiId">PK value for CagriTipi which data should be fetched into this CagriTipi object</param>
		/// <param name="validator">The custom validator object for this CagriTipiEntity</param>
		public CagriTipiEntity(System.Int16 cagriTipiId, IValidator validator):base("CagriTipiEntity")
		{
			InitClassFetch(cagriTipiId, validator, null);
		}

		/// <summary>Private CTor for deserialization</summary>
		/// <param name="info"></param>
		/// <param name="context"></param>
		protected CagriTipiEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Bildirims":
					toReturn.Add(Relations.BildirimEntityUsingFkCagriTipiId);
					break;
				default:
					break;				
			}
		...
		public bool FetchUsingPK(System.Int16 cagriTipiId)
		{
			return FetchUsingPK(cagriTipiId, null, null, null);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int16 cagriTipiId, IPrefetchPath prefetchPathToUse)
		{
			return FetchUsingPK(cagriTipiId, prefetchPathToUse, null, null);
		}
		...
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int16 cagriTipiId, IPrefetchPath prefetchPathToUse, Context contextToUse)
		{
			return FetchUsingPK(cagriTipiId, prefetchPathToUse, contextToUse, null);
		}
		...
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int16 cagriTipiId, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			return Fetch(cagriTipiId, prefetchPathToUse, contextToUse, excludedIncludedFields);
		}
		...
		{
			return Fetch(this.CagriTipiId, null, null, null);
		}
		...
		{
			return new CagriTipiRelations().GetAllRelations();
		}
		...
		public virtual dhmi.CollectionClasses.BildirimCollection GetMultiBildirims(bool forceFetch, IEntityFactory entityFactoryToUse, IPredicateExpression filter)
		{
 			if( ( !_alreadyFetchedBildirims || forceFetch || _alwaysFetchBildirims) && !this.IsSerializing && !this.IsDeserializing && !this.InDesignMode)
			{
				...
				_bildirims.GetMultiManyToOne(null, null, null, null, this, null, null, filter);
		...
		/// <param name="cagriTipiId">PK value for CagriTipi which data should be fetched into this CagriTipi object</param>
		/// <param name="validator">The validator object for this CagriTipiEntity</param>
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		private void InitClassFetch(System.Int16 cagriTipiId, IValidator validator, IPrefetchPath prefetchPathToUse)
		{
			OnInitializing();
			this.Validator = validator;
			this.Fields = CreateFields();
			InitClassMembers();	
			Fetch(cagriTipiId, prefetchPathToUse, null, null);
		...
		private void InitClassMembers()
		{
			...
			_bildirims.SetContainingEntityInfo(this, "CagriTipi");
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("CagriTipiDurum", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("CagriTipiId", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("CagriTipiTarih", fieldHashtable);
		}
		#endregion
		...
		/// is set to false, the fields contained in excludedIncludedFields are kept in the query, the rest of the fields in the query are excluded.</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		private bool Fetch(System.Int16 cagriTipiId, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			try
			{
				OnFetch();
				this.Fields[(int)CagriTipiFieldIndex.CagriTipiId].ForcedCurrentValueWrite(cagriTipiId);
		...
		{
			return DAOFactory.CreateCagriTipiDAO();
		}
		...
		{
			return new CagriTipiEntityFactory();
		}

		#region Class Property Declarations
		/// <summary> The relations object holding all relations of this entity with other entity classes.</summary>
		public  static CagriTipiRelations Relations
		{
			get	{ return new CagriTipiRelations(); }
		}
		...
		{
			get { return new PrefetchPathElement(new dhmi.CollectionClasses.BildirimCollection(), (IEntityRelation)GetRelationsForField("Bildirims")[0], (int)dhmi.EntityType.CagriTipiEntity, (int)dhmi.EntityType.BildirimEntity, 0, null, null, null, "Bildirims", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany); }
		}
		...
		/// <summary> The CagriTipiAd property of the Entity CagriTipi<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Cagri_Tipi"."Cagri_Tipi_Ad"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 75<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String CagriTipiAd
		{
			get { return (System.String)GetValue((int)CagriTipiFieldIndex.CagriTipiAd, true); }
			set	{ SetValue((int)CagriTipiFieldIndex.CagriTipiAd, value, true); }
		}

		/// <summary> The CagriTipiDurum property of the Entity CagriTipi<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Cagri_Tipi"."Cagri_Tipi_Durum"<br/>
		/// Table field type characteristics (type, precision, scale, length): Bit, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Boolean CagriTipiDurum
		{
			get { return (System.Boolean)GetValue((int)CagriTipiFieldIndex.CagriTipiDurum, true); }
			set	{ SetValue((int)CagriTipiFieldIndex.CagriTipiDurum, value, true); }
		}

		/// <summary> The CagriTipiId property of the Entity CagriTipi<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Cagri_Tipi"."Cagri_Tipi_ID"<br/>
		/// Table field type characteristics (type, precision, scale, length): SmallInt, 5, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int16 CagriTipiId
		{
			get { return (System.Int16)GetValue((int)CagriTipiFieldIndex.CagriTipiId, true); }
			set	{ SetValue((int)CagriTipiFieldIndex.CagriTipiId, value, true); }
		}

		/// <summary> The CagriTipiTarih property of the Entity CagriTipi<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Cagri_Tipi"."Cagri_Tipi_Tarih"<br/>
		/// Table field type characteristics (type, precision, scale, length): SmallDateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.DateTime CagriTipiTarih
		{
			get { return (System.DateTime)GetValue((int)CagriTipiFieldIndex.CagriTipiTarih, true); }
			set	{ SetValue((int)CagriTipiFieldIndex.CagriTipiTarih, value, true); }
		}
		...
		{ 
			get { return (int)dhmi.EntityType.CagriTipiEntity; }
		}
