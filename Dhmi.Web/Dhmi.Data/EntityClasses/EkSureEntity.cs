...
namespace dhmi.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'EkSure'. <br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class EkSureEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public EkSureEntity() :base("EkSureEntity")
		{
			InitClassEmpty(null);
		}
		
		/// <summary>CTor</summary>
		/// <param name="ekSureId">PK value for EkSure which data should be fetched into this EkSure object</param>
		public EkSureEntity(System.Int64 ekSureId):base("EkSureEntity")
		{
			InitClassFetch(ekSureId, null, null);
		}

		/// <summary>CTor</summary>
		/// <param name="ekSureId">PK value for EkSure which data should be fetched into this EkSure object</param>
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		public EkSureEntity(System.Int64 ekSureId, IPrefetchPath prefetchPathToUse):base("EkSureEntity")
		{
			InitClassFetch(ekSureId, null, prefetchPathToUse);
		}

		/// <summary>CTor</summary>
		/// <param name="ekSureId">PK value for EkSure which data should be fetched into this EkSure object</param>
		/// <param name="validator">The custom validator object for this EkSureEntity</param>
		public EkSureEntity(System.Int64 ekSureId, IValidator validator):base("EkSureEntity")
		{
			InitClassFetch(ekSureId, validator, null);
		}

		/// <summary>Private CTor for deserialization</summary>
		/// <param name="info"></param>
		/// <param name="context"></param>
		protected EkSureEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((EkSureFieldIndex)fieldIndex)
			{
				case EkSureFieldIndex.FkBildirimId:
					DesetupSyncBildirim(true, false);
					_alreadyFetchedBildirim = false;
					break;
				case EkSureFieldIndex.FkKullaniciId:
		...
		public bool FetchUsingPK(System.Int64 ekSureId)
		{
			return FetchUsingPK(ekSureId, null, null, null);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int64 ekSureId, IPrefetchPath prefetchPathToUse)
		{
			return FetchUsingPK(ekSureId, prefetchPathToUse, null, null);
		}
		...
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int64 ekSureId, IPrefetchPath prefetchPathToUse, Context contextToUse)
		{
			return FetchUsingPK(ekSureId, prefetchPathToUse, contextToUse, null);
		}
		...
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int64 ekSureId, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			return Fetch(ekSureId, prefetchPathToUse, contextToUse, excludedIncludedFields);
		}
		...
		{
			return Fetch(this.EkSureId, null, null, null);
		}
		...
		{
			return new EkSureRelations().GetAllRelations();
		}
		...
		/// <param name="ekSureId">PK value for EkSure which data should be fetched into this EkSure object</param>
		/// <param name="validator">The validator object for this EkSureEntity</param>
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		private void InitClassFetch(System.Int64 ekSureId, IValidator validator, IPrefetchPath prefetchPathToUse)
		{
			OnInitializing();
			this.Validator = validator;
			this.Fields = CreateFields();
			InitClassMembers();	
			Fetch(ekSureId, prefetchPathToUse, null, null);
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			_fieldsCustomProperties.Add("EkSureGun", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("EkSureId", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("EkSureSaat", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("EkSureTarih", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("EkSureTotal", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		{
			this.PerformDesetupSyncRelatedEntity( _bildirim, new PropertyChangedEventHandler( OnBildirimPropertyChanged ), "Bildirim", dhmi.RelationClasses.StaticEkSureRelations.BildirimEntityUsingFkBildirimIdStatic, true, signalRelatedEntity, "EkSures", resetFKFields, new int[] { (int)EkSureFieldIndex.FkBildirimId } );		
			_bildirim = null;
		}
		...
		private void SetupSyncBildirim(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _bildirim, new PropertyChangedEventHandler( OnBildirimPropertyChanged ), "Bildirim", dhmi.RelationClasses.StaticEkSureRelations.BildirimEntityUsingFkBildirimIdStatic, true, ref _alreadyFetchedBildirim, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _kullanici, new PropertyChangedEventHandler( OnKullaniciPropertyChanged ), "Kullanici", dhmi.RelationClasses.StaticEkSureRelations.KullaniciEntityUsingFkKullaniciIdStatic, true, signalRelatedEntity, "EkSures", resetFKFields, new int[] { (int)EkSureFieldIndex.FkKullaniciId } );		
			_kullanici = null;
		}
		...
		private void SetupSyncKullanici(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _kullanici, new PropertyChangedEventHandler( OnKullaniciPropertyChanged ), "Kullanici", dhmi.RelationClasses.StaticEkSureRelations.KullaniciEntityUsingFkKullaniciIdStatic, true, ref _alreadyFetchedKullanici, new string[] {  } );
			}
		}
		...
		/// is set to false, the fields contained in excludedIncludedFields are kept in the query, the rest of the fields in the query are excluded.</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		private bool Fetch(System.Int64 ekSureId, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			try
			{
				OnFetch();
				this.Fields[(int)EkSureFieldIndex.EkSureId].ForcedCurrentValueWrite(ekSureId);
		...
		{
			return DAOFactory.CreateEkSureDAO();
		}
		...
		{
			return new EkSureEntityFactory();
		}

		#region Class Property Declarations
		/// <summary> The relations object holding all relations of this entity with other entity classes.</summary>
		public  static EkSureRelations Relations
		{
			get	{ return new EkSureRelations(); }
		}
		...
		{
			get	{ return new PrefetchPathElement(new dhmi.CollectionClasses.BildirimCollection(), (IEntityRelation)GetRelationsForField("Bildirim")[0], (int)dhmi.EntityType.EkSureEntity, (int)dhmi.EntityType.BildirimEntity, 0, null, null, null, "Bildirim", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement(new dhmi.CollectionClasses.KullaniciCollection(), (IEntityRelation)GetRelationsForField("Kullanici")[0], (int)dhmi.EntityType.EkSureEntity, (int)dhmi.EntityType.KullaniciEntity, 0, null, null, null, "Kullanici", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The EkSureGun property of the Entity EkSure<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Ek_Sure"."Ek_Sure_Gun"<br/>
		/// Table field type characteristics (type, precision, scale, length): SmallInt, 5, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int16 EkSureGun
		{
			get { return (System.Int16)GetValue((int)EkSureFieldIndex.EkSureGun, true); }
			set	{ SetValue((int)EkSureFieldIndex.EkSureGun, value, true); }
		}

		/// <summary> The EkSureId property of the Entity EkSure<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Ek_Sure"."Ek_Sure_ID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int64 EkSureId
		{
			get { return (System.Int64)GetValue((int)EkSureFieldIndex.EkSureId, true); }
			set	{ SetValue((int)EkSureFieldIndex.EkSureId, value, true); }
		}

		/// <summary> The EkSureSaat property of the Entity EkSure<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Ek_Sure"."Ek_Sure_Saat"<br/>
		/// Table field type characteristics (type, precision, scale, length): SmallInt, 5, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int16 EkSureSaat
		{
			get { return (System.Int16)GetValue((int)EkSureFieldIndex.EkSureSaat, true); }
			set	{ SetValue((int)EkSureFieldIndex.EkSureSaat, value, true); }
		}

		/// <summary> The EkSureTarih property of the Entity EkSure<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Ek_Sure"."Ek_Sure_Tarih"<br/>
		/// Table field type characteristics (type, precision, scale, length): SmallDateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.DateTime EkSureTarih
		{
			get { return (System.DateTime)GetValue((int)EkSureFieldIndex.EkSureTarih, true); }
			set	{ SetValue((int)EkSureFieldIndex.EkSureTarih, value, true); }
		}

		/// <summary> The EkSureTotal property of the Entity EkSure<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Ek_Sure"."Ek_Sure_Total"<br/>
		/// Table field type characteristics (type, precision, scale, length): SmallInt, 5, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int16 EkSureTotal
		{
			get { return (System.Int16)GetValue((int)EkSureFieldIndex.EkSureTotal, true); }
			set	{ SetValue((int)EkSureFieldIndex.EkSureTotal, value, true); }
		}

		/// <summary> The FkBildirimId property of the Entity EkSure<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Ek_Sure"."FK_Bildirim_ID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int64 FkBildirimId
		{
			get { return (System.Int64)GetValue((int)EkSureFieldIndex.FkBildirimId, true); }
			set	{ SetValue((int)EkSureFieldIndex.FkBildirimId, value, true); }
		}

		/// <summary> The FkKullaniciId property of the Entity EkSure<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Ek_Sure"."FK_Kullanici_ID"<br/>
		/// Table field type characteristics (type, precision, scale, length): SmallInt, 5, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int16 FkKullaniciId
		{
			get { return (System.Int16)GetValue((int)EkSureFieldIndex.FkKullaniciId, true); }
			set	{ SetValue((int)EkSureFieldIndex.FkKullaniciId, value, true); }
		}
		...
		public virtual BildirimEntity Bildirim
		{
			...
			{ 
				...
				{
					SetSingleRelatedEntityNavigator(value, "EkSures", "Bildirim", _bildirim, true); 
				}
			}
		}
		...
		public virtual KullaniciEntity Kullanici
		{
			...
			{ 
				...
				{
					SetSingleRelatedEntityNavigator(value, "EkSures", "Kullanici", _kullanici, true); 
				}
			}
		}
		...
		{ 
			get { return (int)dhmi.EntityType.EkSureEntity; }
		}
