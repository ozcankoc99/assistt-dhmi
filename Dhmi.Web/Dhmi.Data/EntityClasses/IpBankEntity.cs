...
namespace dhmi.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'IpBank'. <br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class IpBankEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public IpBankEntity() :base("IpBankEntity")
		{
			InitClassEmpty(null);
		}
		
		/// <summary>CTor</summary>
		/// <param name="ipBanksId">PK value for IpBank which data should be fetched into this IpBank object</param>
		public IpBankEntity(System.Int64 ipBanksId):base("IpBankEntity")
		{
			InitClassFetch(ipBanksId, null, null);
		}

		/// <summary>CTor</summary>
		/// <param name="ipBanksId">PK value for IpBank which data should be fetched into this IpBank object</param>
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		public IpBankEntity(System.Int64 ipBanksId, IPrefetchPath prefetchPathToUse):base("IpBankEntity")
		{
			InitClassFetch(ipBanksId, null, prefetchPathToUse);
		}

		/// <summary>CTor</summary>
		/// <param name="ipBanksId">PK value for IpBank which data should be fetched into this IpBank object</param>
		/// <param name="validator">The custom validator object for this IpBankEntity</param>
		public IpBankEntity(System.Int64 ipBanksId, IValidator validator):base("IpBankEntity")
		{
			InitClassFetch(ipBanksId, validator, null);
		}

		/// <summary>Private CTor for deserialization</summary>
		/// <param name="info"></param>
		/// <param name="context"></param>
		protected IpBankEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((IpBankFieldIndex)fieldIndex)
			{
				case IpBankFieldIndex.FkKullaniciId:
		...
		public bool FetchUsingPK(System.Int64 ipBanksId)
		{
			return FetchUsingPK(ipBanksId, null, null, null);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int64 ipBanksId, IPrefetchPath prefetchPathToUse)
		{
			return FetchUsingPK(ipBanksId, prefetchPathToUse, null, null);
		}
		...
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int64 ipBanksId, IPrefetchPath prefetchPathToUse, Context contextToUse)
		{
			return FetchUsingPK(ipBanksId, prefetchPathToUse, contextToUse, null);
		}
		...
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int64 ipBanksId, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			return Fetch(ipBanksId, prefetchPathToUse, contextToUse, excludedIncludedFields);
		}
		...
		{
			return Fetch(this.IpBanksId, null, null, null);
		}
		...
		{
			return new IpBankRelations().GetAllRelations();
		}
		...
		/// <param name="ipBanksId">PK value for IpBank which data should be fetched into this IpBank object</param>
		/// <param name="validator">The validator object for this IpBankEntity</param>
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		private void InitClassFetch(System.Int64 ipBanksId, IValidator validator, IPrefetchPath prefetchPathToUse)
		{
			OnInitializing();
			this.Validator = validator;
			this.Fields = CreateFields();
			InitClassMembers();	
			Fetch(ipBanksId, prefetchPathToUse, null, null);
		...
		{
			this.PerformDesetupSyncRelatedEntity( _kullanici, new PropertyChangedEventHandler( OnKullaniciPropertyChanged ), "Kullanici", dhmi.RelationClasses.StaticIpBankRelations.KullaniciEntityUsingFkKullaniciIdStatic, true, signalRelatedEntity, "IpBanks", resetFKFields, new int[] { (int)IpBankFieldIndex.FkKullaniciId } );		
			_kullanici = null;
		}
		...
		private void SetupSyncKullanici(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _kullanici, new PropertyChangedEventHandler( OnKullaniciPropertyChanged ), "Kullanici", dhmi.RelationClasses.StaticIpBankRelations.KullaniciEntityUsingFkKullaniciIdStatic, true, ref _alreadyFetchedKullanici, new string[] {  } );
			}
		}
		...
		/// is set to false, the fields contained in excludedIncludedFields are kept in the query, the rest of the fields in the query are excluded.</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		private bool Fetch(System.Int64 ipBanksId, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			try
			{
				OnFetch();
				this.Fields[(int)IpBankFieldIndex.IpBanksId].ForcedCurrentValueWrite(ipBanksId);
		...
		{
			return DAOFactory.CreateIpBankDAO();
		}
		...
		{
			return new IpBankEntityFactory();
		}

		#region Class Property Declarations
		/// <summary> The relations object holding all relations of this entity with other entity classes.</summary>
		public  static IpBankRelations Relations
		{
			get	{ return new IpBankRelations(); }
		}
		...
		{
			get	{ return new PrefetchPathElement(new dhmi.CollectionClasses.KullaniciCollection(), (IEntityRelation)GetRelationsForField("Kullanici")[0], (int)dhmi.EntityType.IpBankEntity, (int)dhmi.EntityType.KullaniciEntity, 0, null, null, null, "Kullanici", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The FkKullaniciId property of the Entity IpBank<br/><br/></summary>
		/// <remarks>Mapped on  table field: "IP_Banks"."FK_Kullanici_ID"<br/>
		/// Table field type characteristics (type, precision, scale, length): SmallInt, 5, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int16 FkKullaniciId
		{
			get { return (System.Int16)GetValue((int)IpBankFieldIndex.FkKullaniciId, true); }
			set	{ SetValue((int)IpBankFieldIndex.FkKullaniciId, value, true); }
		}

		/// <summary> The IpBanksAciklama property of the Entity IpBank<br/><br/></summary>
		/// <remarks>Mapped on  table field: "IP_Banks"."IP_Banks_Aciklama"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 250<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String IpBanksAciklama
		{
			get { return (System.String)GetValue((int)IpBankFieldIndex.IpBanksAciklama, true); }
			set	{ SetValue((int)IpBankFieldIndex.IpBanksAciklama, value, true); }
		}

		/// <summary> The IpBanksAd property of the Entity IpBank<br/><br/></summary>
		/// <remarks>Mapped on  table field: "IP_Banks"."IP_Banks_Ad"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 30<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String IpBanksAd
		{
			get { return (System.String)GetValue((int)IpBankFieldIndex.IpBanksAd, true); }
			set	{ SetValue((int)IpBankFieldIndex.IpBanksAd, value, true); }
		}

		/// <summary> The IpBanksDurum property of the Entity IpBank<br/><br/></summary>
		/// <remarks>Mapped on  table field: "IP_Banks"."IP_Banks_Durum"<br/>
		/// Table field type characteristics (type, precision, scale, length): Bit, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Boolean IpBanksDurum
		{
			get { return (System.Boolean)GetValue((int)IpBankFieldIndex.IpBanksDurum, true); }
			set	{ SetValue((int)IpBankFieldIndex.IpBanksDurum, value, true); }
		}

		/// <summary> The IpBanksId property of the Entity IpBank<br/><br/></summary>
		/// <remarks>Mapped on  table field: "IP_Banks"."IP_Banks_ID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int64 IpBanksId
		{
			get { return (System.Int64)GetValue((int)IpBankFieldIndex.IpBanksId, true); }
			set	{ SetValue((int)IpBankFieldIndex.IpBanksId, value, true); }
		}

		/// <summary> The IpBanksTarih property of the Entity IpBank<br/><br/></summary>
		/// <remarks>Mapped on  table field: "IP_Banks"."IP_Banks_Tarih"<br/>
		/// Table field type characteristics (type, precision, scale, length): SmallDateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.DateTime IpBanksTarih
		{
			get { return (System.DateTime)GetValue((int)IpBankFieldIndex.IpBanksTarih, true); }
			set	{ SetValue((int)IpBankFieldIndex.IpBanksTarih, value, true); }
		}
		...
		public virtual KullaniciEntity Kullanici
		{
			...
			{ 
				...
				{
					SetSingleRelatedEntityNavigator(value, "IpBanks", "Kullanici", _kullanici, true); 
				}
			}
		}
		...
		{ 
			get { return (int)dhmi.EntityType.IpBankEntity; }
		}
