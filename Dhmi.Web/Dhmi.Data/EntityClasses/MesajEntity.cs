...
namespace dhmi.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'Mesaj'. <br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class MesajEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		public MesajEntity() :base("MesajEntity")
		{
			InitClassEmpty(null);
		}
		
		/// <summary>CTor</summary>
		/// <param name="mesajId">PK value for Mesaj which data should be fetched into this Mesaj object</param>
		public MesajEntity(System.Int64 mesajId):base("MesajEntity")
		{
			InitClassFetch(mesajId, null, null);
		}

		/// <summary>CTor</summary>
		/// <param name="mesajId">PK value for Mesaj which data should be fetched into this Mesaj object</param>
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		public MesajEntity(System.Int64 mesajId, IPrefetchPath prefetchPathToUse):base("MesajEntity")
		{
			InitClassFetch(mesajId, null, prefetchPathToUse);
		}

		/// <summary>CTor</summary>
		/// <param name="mesajId">PK value for Mesaj which data should be fetched into this Mesaj object</param>
		/// <param name="validator">The custom validator object for this MesajEntity</param>
		public MesajEntity(System.Int64 mesajId, IValidator validator):base("MesajEntity")
		{
			InitClassFetch(mesajId, validator, null);
		}

		/// <summary>Private CTor for deserialization</summary>
		/// <param name="info"></param>
		/// <param name="context"></param>
		protected MesajEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((MesajFieldIndex)fieldIndex)
			{
				case MesajFieldIndex.FkKullaniciId:
		...
		public bool FetchUsingPK(System.Int64 mesajId)
		{
			return FetchUsingPK(mesajId, null, null, null);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int64 mesajId, IPrefetchPath prefetchPathToUse)
		{
			return FetchUsingPK(mesajId, prefetchPathToUse, null, null);
		}
		...
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int64 mesajId, IPrefetchPath prefetchPathToUse, Context contextToUse)
		{
			return FetchUsingPK(mesajId, prefetchPathToUse, contextToUse, null);
		}
		...
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int64 mesajId, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			return Fetch(mesajId, prefetchPathToUse, contextToUse, excludedIncludedFields);
		}
		...
		{
			return Fetch(this.MesajId, null, null, null);
		}
		...
		{
			return new MesajRelations().GetAllRelations();
		}
		...
		/// <param name="mesajId">PK value for Mesaj which data should be fetched into this Mesaj object</param>
		/// <param name="validator">The validator object for this MesajEntity</param>
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		private void InitClassFetch(System.Int64 mesajId, IValidator validator, IPrefetchPath prefetchPathToUse)
		{
			OnInitializing();
			this.Validator = validator;
			this.Fields = CreateFields();
			InitClassMembers();	
			Fetch(mesajId, prefetchPathToUse, null, null);
		...
		{
			this.PerformDesetupSyncRelatedEntity( _kullanici, new PropertyChangedEventHandler( OnKullaniciPropertyChanged ), "Kullanici", dhmi.RelationClasses.StaticMesajRelations.KullaniciEntityUsingFkKullaniciIdStatic, true, signalRelatedEntity, "Mesajs", resetFKFields, new int[] { (int)MesajFieldIndex.FkKullaniciId } );		
			_kullanici = null;
		}
		...
		private void SetupSyncKullanici(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _kullanici, new PropertyChangedEventHandler( OnKullaniciPropertyChanged ), "Kullanici", dhmi.RelationClasses.StaticMesajRelations.KullaniciEntityUsingFkKullaniciIdStatic, true, ref _alreadyFetchedKullanici, new string[] {  } );
			}
		}
		...
		/// is set to false, the fields contained in excludedIncludedFields are kept in the query, the rest of the fields in the query are excluded.</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		private bool Fetch(System.Int64 mesajId, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			try
			{
				OnFetch();
				this.Fields[(int)MesajFieldIndex.MesajId].ForcedCurrentValueWrite(mesajId);
		...
		{
			return DAOFactory.CreateMesajDAO();
		}
		...
		{
			return new MesajEntityFactory();
		}

		#region Class Property Declarations
		/// <summary> The relations object holding all relations of this entity with other entity classes.</summary>
		public  static MesajRelations Relations
		{
			get	{ return new MesajRelations(); }
		}
		...
		{
			get	{ return new PrefetchPathElement(new dhmi.CollectionClasses.KullaniciCollection(), (IEntityRelation)GetRelationsForField("Kullanici")[0], (int)dhmi.EntityType.MesajEntity, (int)dhmi.EntityType.KullaniciEntity, 0, null, null, null, "Kullanici", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The FkKullaniciId property of the Entity Mesaj<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Mesaj"."FK_Kullanici_ID"<br/>
		/// Table field type characteristics (type, precision, scale, length): SmallInt, 5, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int16 FkKullaniciId
		{
			get { return (System.Int16)GetValue((int)MesajFieldIndex.FkKullaniciId, true); }
			set	{ SetValue((int)MesajFieldIndex.FkKullaniciId, value, true); }
		}

		/// <summary> The MesajBaslik property of the Entity Mesaj<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Mesaj"."Mesaj_Baslik"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 100<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String MesajBaslik
		{
			get { return (System.String)GetValue((int)MesajFieldIndex.MesajBaslik, true); }
			set	{ SetValue((int)MesajFieldIndex.MesajBaslik, value, true); }
		}

		/// <summary> The MesajHangiKullanici property of the Entity Mesaj<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Mesaj"."Mesaj_Hangi_Kullanici"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 75<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String MesajHangiKullanici
		{
			get { return (System.String)GetValue((int)MesajFieldIndex.MesajHangiKullanici, true); }
			set	{ SetValue((int)MesajFieldIndex.MesajHangiKullanici, value, true); }
		}

		/// <summary> The MesajIcerik property of the Entity Mesaj<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Mesaj"."Mesaj_Icerik"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 500<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String MesajIcerik
		{
			get { return (System.String)GetValue((int)MesajFieldIndex.MesajIcerik, true); }
			set	{ SetValue((int)MesajFieldIndex.MesajIcerik, value, true); }
		}

		/// <summary> The MesajId property of the Entity Mesaj<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Mesaj"."Mesaj_ID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int64 MesajId
		{
			get { return (System.Int64)GetValue((int)MesajFieldIndex.MesajId, true); }
			set	{ SetValue((int)MesajFieldIndex.MesajId, value, true); }
		}

		/// <summary> The MesajTarih property of the Entity Mesaj<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Mesaj"."Mesaj_Tarih"<br/>
		/// Table field type characteristics (type, precision, scale, length): SmallDateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.DateTime MesajTarih
		{
			get { return (System.DateTime)GetValue((int)MesajFieldIndex.MesajTarih, true); }
			set	{ SetValue((int)MesajFieldIndex.MesajTarih, value, true); }
		}
		...
		public virtual KullaniciEntity Kullanici
		{
			...
			{ 
				...
				{
					SetSingleRelatedEntityNavigator(value, "Mesajs", "Kullanici", _kullanici, true); 
				}
			}
		}
		...
		{ 
			get { return (int)dhmi.EntityType.MesajEntity; }
		}
