...
namespace dhmi.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'RaporYetki'. <br/><br/>
	/// 
	/// </summary>
	[Serializable]
	public partial class RaporYetkiEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static RaporYetkiEntity()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary>CTor</summary>
		public RaporYetkiEntity() :base("RaporYetkiEntity")
		{
			InitClassEmpty(null);
		}
		
		/// <summary>CTor</summary>
		/// <param name="raporYetkiId">PK value for RaporYetki which data should be fetched into this RaporYetki object</param>
		public RaporYetkiEntity(System.Int64 raporYetkiId):base("RaporYetkiEntity")
		{
			InitClassFetch(raporYetkiId, null, null);
		}

		/// <summary>CTor</summary>
		/// <param name="raporYetkiId">PK value for RaporYetki which data should be fetched into this RaporYetki object</param>
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		public RaporYetkiEntity(System.Int64 raporYetkiId, IPrefetchPath prefetchPathToUse):base("RaporYetkiEntity")
		{
			InitClassFetch(raporYetkiId, null, prefetchPathToUse);
		}

		/// <summary>CTor</summary>
		/// <param name="raporYetkiId">PK value for RaporYetki which data should be fetched into this RaporYetki object</param>
		/// <param name="validator">The custom validator object for this RaporYetkiEntity</param>
		public RaporYetkiEntity(System.Int64 raporYetkiId, IValidator validator):base("RaporYetkiEntity")
		{
			InitClassFetch(raporYetkiId, validator, null);
		}

		/// <summary>Private CTor for deserialization</summary>
		/// <param name="info"></param>
		/// <param name="context"></param>
		protected RaporYetkiEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((RaporYetkiFieldIndex)fieldIndex)
			{
				case RaporYetkiFieldIndex.FkKullaniciId:
					DesetupSyncKullanici(true, false);
					_alreadyFetchedKullanici = false;
					break;
				case RaporYetkiFieldIndex.FkRaporTuruId:
		...
		public bool FetchUsingPK(System.Int64 raporYetkiId)
		{
			return FetchUsingPK(raporYetkiId, null, null, null);
		}
		...
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int64 raporYetkiId, IPrefetchPath prefetchPathToUse)
		{
			return FetchUsingPK(raporYetkiId, prefetchPathToUse, null, null);
		}
		...
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int64 raporYetkiId, IPrefetchPath prefetchPathToUse, Context contextToUse)
		{
			return FetchUsingPK(raporYetkiId, prefetchPathToUse, contextToUse, null);
		}
		...
		/// <returns>True if succeeded, false otherwise.</returns>
		public bool FetchUsingPK(System.Int64 raporYetkiId, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			return Fetch(raporYetkiId, prefetchPathToUse, contextToUse, excludedIncludedFields);
		}
		...
		{
			return Fetch(this.RaporYetkiId, null, null, null);
		}
		...
		{
			return new RaporYetkiRelations().GetAllRelations();
		}
		...
		/// <param name="raporYetkiId">PK value for RaporYetki which data should be fetched into this RaporYetki object</param>
		/// <param name="validator">The validator object for this RaporYetkiEntity</param>
		/// <param name="prefetchPathToUse">the PrefetchPath which defines the graph of objects to fetch as well</param>
		private void InitClassFetch(System.Int64 raporYetkiId, IValidator validator, IPrefetchPath prefetchPathToUse)
		{
			OnInitializing();
			this.Validator = validator;
			this.Fields = CreateFields();
			InitClassMembers();	
			Fetch(raporYetkiId, prefetchPathToUse, null, null);
		...
		{
			this.PerformDesetupSyncRelatedEntity( _kullanici, new PropertyChangedEventHandler( OnKullaniciPropertyChanged ), "Kullanici", dhmi.RelationClasses.StaticRaporYetkiRelations.KullaniciEntityUsingFkKullaniciIdStatic, true, signalRelatedEntity, "RaporYetkis", resetFKFields, new int[] { (int)RaporYetkiFieldIndex.FkKullaniciId } );		
			_kullanici = null;
		}
		...
		private void SetupSyncKullanici(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _kullanici, new PropertyChangedEventHandler( OnKullaniciPropertyChanged ), "Kullanici", dhmi.RelationClasses.StaticRaporYetkiRelations.KullaniciEntityUsingFkKullaniciIdStatic, true, ref _alreadyFetchedKullanici, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _raporTuru, new PropertyChangedEventHandler( OnRaporTuruPropertyChanged ), "RaporTuru", dhmi.RelationClasses.StaticRaporYetkiRelations.RaporTuruEntityUsingFkRaporTuruIdStatic, true, signalRelatedEntity, "RaporYetkis", resetFKFields, new int[] { (int)RaporYetkiFieldIndex.FkRaporTuruId } );		
			_raporTuru = null;
		}
		...
		private void SetupSyncRaporTuru(IEntityCore relatedEntity)
		{
			...
			{		
				...
				this.PerformSetupSyncRelatedEntity( _raporTuru, new PropertyChangedEventHandler( OnRaporTuruPropertyChanged ), "RaporTuru", dhmi.RelationClasses.StaticRaporYetkiRelations.RaporTuruEntityUsingFkRaporTuruIdStatic, true, ref _alreadyFetchedRaporTuru, new string[] {  } );
			}
		}
		...
		/// is set to false, the fields contained in excludedIncludedFields are kept in the query, the rest of the fields in the query are excluded.</param>
		/// <returns>True if succeeded, false otherwise.</returns>
		private bool Fetch(System.Int64 raporYetkiId, IPrefetchPath prefetchPathToUse, Context contextToUse, ExcludeIncludeFieldsList excludedIncludedFields)
		{
			try
			{
				OnFetch();
				this.Fields[(int)RaporYetkiFieldIndex.RaporYetkiId].ForcedCurrentValueWrite(raporYetkiId);
		...
		{
			return DAOFactory.CreateRaporYetkiDAO();
		}
		...
		{
			return new RaporYetkiEntityFactory();
		}

		#region Class Property Declarations
		/// <summary> The relations object holding all relations of this entity with other entity classes.</summary>
		public  static RaporYetkiRelations Relations
		{
			get	{ return new RaporYetkiRelations(); }
		}
		...
		{
			get	{ return new PrefetchPathElement(new dhmi.CollectionClasses.KullaniciCollection(), (IEntityRelation)GetRelationsForField("Kullanici")[0], (int)dhmi.EntityType.RaporYetkiEntity, (int)dhmi.EntityType.KullaniciEntity, 0, null, null, null, "Kullanici", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement(new dhmi.CollectionClasses.RaporTuruCollection(), (IEntityRelation)GetRelationsForField("RaporTuru")[0], (int)dhmi.EntityType.RaporYetkiEntity, (int)dhmi.EntityType.RaporTuruEntity, 0, null, null, null, "RaporTuru", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The FkKullaniciId property of the Entity RaporYetki<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Rapor_Yetki"."FK_Kullanici_ID"<br/>
		/// Table field type characteristics (type, precision, scale, length): SmallInt, 5, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int16 FkKullaniciId
		{
			get { return (System.Int16)GetValue((int)RaporYetkiFieldIndex.FkKullaniciId, true); }
			set	{ SetValue((int)RaporYetkiFieldIndex.FkKullaniciId, value, true); }
		}

		/// <summary> The FkRaporTuruId property of the Entity RaporYetki<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Rapor_Yetki"."FK_Rapor_Turu_ID"<br/>
		/// Table field type characteristics (type, precision, scale, length): SmallInt, 5, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int16 FkRaporTuruId
		{
			get { return (System.Int16)GetValue((int)RaporYetkiFieldIndex.FkRaporTuruId, true); }
			set	{ SetValue((int)RaporYetkiFieldIndex.FkRaporTuruId, value, true); }
		}

		/// <summary> The RaporYetkiDurum property of the Entity RaporYetki<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Rapor_Yetki"."Rapor_Yetki_Durum"<br/>
		/// Table field type characteristics (type, precision, scale, length): Bit, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Boolean RaporYetkiDurum
		{
			get { return (System.Boolean)GetValue((int)RaporYetkiFieldIndex.RaporYetkiDurum, true); }
			set	{ SetValue((int)RaporYetkiFieldIndex.RaporYetkiDurum, value, true); }
		}

		/// <summary> The RaporYetkiId property of the Entity RaporYetki<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Rapor_Yetki"."Rapor_Yetki_ID"<br/>
		/// Table field type characteristics (type, precision, scale, length): BigInt, 19, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int64 RaporYetkiId
		{
			get { return (System.Int64)GetValue((int)RaporYetkiFieldIndex.RaporYetkiId, true); }
			set	{ SetValue((int)RaporYetkiFieldIndex.RaporYetkiId, value, true); }
		}

		/// <summary> The RaporYetkiTarih property of the Entity RaporYetki<br/><br/></summary>
		/// <remarks>Mapped on  table field: "Rapor_Yetki"."Rapor_Yetki_Tarih"<br/>
		/// Table field type characteristics (type, precision, scale, length): DateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.DateTime RaporYetkiTarih
		{
			get { return (System.DateTime)GetValue((int)RaporYetkiFieldIndex.RaporYetkiTarih, true); }
			set	{ SetValue((int)RaporYetkiFieldIndex.RaporYetkiTarih, value, true); }
		}
		...
		public virtual KullaniciEntity Kullanici
		{
			...
			{ 
				...
				{
					SetSingleRelatedEntityNavigator(value, "RaporYetkis", "Kullanici", _kullanici, true); 
				}
			}
		}
		...
		public virtual RaporTuruEntity RaporTuru
		{
			...
			{ 
				...
				{
					SetSingleRelatedEntityNavigator(value, "RaporYetkis", "RaporTuru", _raporTuru, true); 
				}
			}
		}
		...
		{ 
			get { return (int)dhmi.EntityType.RaporYetkiEntity; }
		}
