...
namespace dhmi.FactoryClasses
{
	...
	{
		private static readonly Dictionary<dhmi.EntityType, string> _entityTypeNamesCache = new Dictionary<dhmi.EntityType, string>();

		/// <summary>static ctor which initializes the static entity type cache.</summary>
		static EntityFieldsFactory()
		{
			foreach(dhmi.EntityType value in Enum.GetValues(typeof(dhmi.EntityType)))
			{
				_entityTypeNamesCache.Add(value, Enum.GetName(typeof(dhmi.EntityType), value));
			}
		}	
		...
		public static IEntityFields CreateEntityFieldsObject(dhmi.EntityType relatedEntityType)
		{
