...
namespace dhmi.TypedListClasses
{
	...
	/// <summary>Typed datatable for the list 'ListAtama'.<br/><br/></summary>
	[Serializable, System.ComponentModel.DesignerCategory("Code")]
	[ToolboxItem(true)]
	[DesignTimeVisible(true)]
	public partial class ListAtamaTypedList : TypedListBase<ListAtamaRow>
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private DataColumn _columnBildirimTuruDurum;
		...
		private DataColumn _columnFkBildirimId_;
		...
		private const int AmountOfFields = 46;
		#endregion

		/// <summary>Static CTor for setting up custom property hashtables.</summary>
		static ListAtamaTypedList()
		{
			SetupCustomPropertyHashtables();
		}
		
		/// <summary>CTor</summary>
		public ListAtamaTypedList():base("ListAtama")
		{
			InitClass(false);
		}
		...
		public ListAtamaTypedList(bool obeyWeakRelations):base("ListAtama")
		{
		...
		protected ListAtamaTypedList(SerializationInfo info, StreamingContext context):base(info, context)
		{
			InitMembers();
		}
#endif		
		...
		{
			ListAtamaTypedList cloneToReturn = ((ListAtamaTypedList)(base.Clone()));
		...
		{
			return new ListAtamaRow(rowBuilder);
		}
		...
		protected override IRelationCollection BuildRelationSet()
		{
			...
			toReturn.Add(BildirimAtamaGrupEntity.Relations.BildirimEntityUsingFkBildirimId, "", "", JoinHint.Inner);
		...
		protected override IEntityFields BuildResultset()
		{
			...
			toReturn.DefineField(BildirimFields.BildirimId, 0, "BildirimId", "", AggregateFunction.None);
			toReturn.DefineField(VatandaFields.VatandasAdSoyad, 1, "VatandasAdSoyad", "", AggregateFunction.None);
			toReturn.DefineField(VatandaFields.VatandasTcNo, 2, "VatandasTcNo", "", AggregateFunction.None);
			toReturn.DefineField(VatandaFields.VatandasTel1, 3, "VatandasTel1", "", AggregateFunction.None);
			toReturn.DefineField(BildirimGeriDonuFields.BildirimGeriDonusAd, 4, "BildirimGeriDonusAd", "", AggregateFunction.None);
			toReturn.DefineField(BildirimSonucFields.BildirimSonucAd, 5, "BildirimSonucAd", "", AggregateFunction.None);
			toReturn.DefineField(BildirimTuruFields.BildirimTuruAd, 6, "BildirimTuruAd", "", AggregateFunction.None);
			toReturn.DefineField(BildirimTuruFields.BildirimTuruDurum, 7, "BildirimTuruDurum", "", AggregateFunction.None);
			toReturn.DefineField(CagriTipiFields.CagriTipiAd, 8, "CagriTipiAd", "", AggregateFunction.None);
			toReturn.DefineField(AltKonuFields.AltKonuAd, 9, "AltKonuAd", "", AggregateFunction.None);
			toReturn.DefineField(BildirimFields.BildirimAciklama, 10, "BildirimAciklama", "", AggregateFunction.None);
			toReturn.DefineField(BildirimFields.BildirimDavaAdSoyad, 11, "BildirimDavaAdSoyad", "", AggregateFunction.None);
			toReturn.DefineField(BildirimFields.BildirimDavaDosyaNo, 12, "BildirimDavaDosyaNo", "", AggregateFunction.None);
			toReturn.DefineField(BildirimFields.BildirimDavaKonu, 13, "BildirimDavaKonu", "", AggregateFunction.None);
			toReturn.DefineField(BildirimFields.BildirimDavaMahkeme, 14, "BildirimDavaMahkeme", "", AggregateFunction.None);
			toReturn.DefineField(BildirimFields.BildirimGelenYer, 15, "BildirimGelenYer", "", AggregateFunction.None);
			toReturn.DefineField(BildirimFields.BildirimGeriYapildiMi, 16, "BildirimGeriYapildiMi", "", AggregateFunction.None);
			toReturn.DefineField(BildirimFields.BildirimHavalimani, 17, "BildirimHavalimani", "", AggregateFunction.None);
			toReturn.DefineField(BildirimFields.BildirimAtanmaDurumu, 18, "BildirimAtanmaDurumu", "", AggregateFunction.None);
			toReturn.DefineField(BildirimFields.BildirimKimBitirdi, 19, "BildirimKimBitirdi", "", AggregateFunction.None);
			toReturn.DefineField(BildirimFields.BildirimKonuDiger, 20, "BildirimKonuDiger", "", AggregateFunction.None);
			toReturn.DefineField(BildirimFields.BildirimSonIslemTarih, 21, "BildirimSonIslemTarih", "", AggregateFunction.None);
			toReturn.DefineField(BildirimFields.BildirimMetin, 22, "BildirimMetin", "", AggregateFunction.None);
			toReturn.DefineField(BildirimFields.BildirimTarih, 23, "BildirimTarih", "", AggregateFunction.None);
			toReturn.DefineField(BildirimFields.BildirimToplamSure, 24, "BildirimToplamSure", "", AggregateFunction.None);
			toReturn.DefineField(BildirimFields.BildirimYil, 25, "BildirimYil", "", AggregateFunction.None);
			toReturn.DefineField(BildirimFields.BildirimYonlendirilenKurum, 26, "BildirimYonlendirilenKurum", "", AggregateFunction.None);
			toReturn.DefineField(BildirimFields.FkBildirimGeriDonusId, 27, "FkBildirimGeriDonusId", "", AggregateFunction.None);
			toReturn.DefineField(BildirimFields.FkAltKonuId, 28, "FkAltKonuId", "", AggregateFunction.None);
			toReturn.DefineField(BildirimFields.FkBildirimSonucId, 29, "FkBildirimSonucId", "", AggregateFunction.None);
			toReturn.DefineField(BildirimFields.FkCagriTipiId, 30, "FkCagriTipiId", "", AggregateFunction.None);
			toReturn.DefineField(BildirimFields.FkBildirimTuruId, 31, "FkBildirimTuruId", "", AggregateFunction.None);
			toReturn.DefineField(BildirimFields.FkVatandasId, 32, "FkVatandasId", "", AggregateFunction.None);
			toReturn.DefineField(BildirimFields.FkKullaniciId, 33, "FkKullaniciId", "", AggregateFunction.None);
			toReturn.DefineField(KullaniciFields.KullaniciAdSoyad, 34, "KullaniciAdSoyad", "", AggregateFunction.None);
			toReturn.DefineField(BildirimAtamaKullaniciFields.BildirimAtamaKullaniciBittiMi, 35, "BildirimAtamaKullaniciBittiMi", "", AggregateFunction.None);
			toReturn.DefineField(BildirimAtamaKullaniciFields.FkKullaniciId, 36, "FkKullaniciId_", "", AggregateFunction.None);
			toReturn.DefineField(KullaniciFields.KullaniciId, 37, "KullaniciId", "", AggregateFunction.None);
			toReturn.DefineField(BildirimAtamaGrupFields.FkBildirimId, 38, "FkBildirimId", "", AggregateFunction.None);
			toReturn.DefineField(BildirimAtamaKullaniciFields.FkBildirimId, 39, "FkBildirimId_", "", AggregateFunction.None);
			toReturn.DefineField(BildirimAtamaGrupFields.FkGrupId, 40, "FkGrupId", "", AggregateFunction.None);
			toReturn.DefineField(AltKonuFields.FkKonuId, 41, "FkKonuId", "", AggregateFunction.None);
			toReturn.DefineField(BildirimAtamaKullaniciFields.BildirimAtamaKullaniciTarih, 42, "BildirimAtamaKullaniciTarih", "", AggregateFunction.None);
			toReturn.DefineField(VatandaFields.VatandasPasaportNo, 43, "VatandasPasaportNo", "", AggregateFunction.None);
			toReturn.DefineField(VatandaFields.VatandasId, 44, "VatandasId", "", AggregateFunction.None);
			toReturn.DefineField(BildirimFields.BildirimVatandasKarar, 45, "BildirimVatandasKarar", "", AggregateFunction.None);
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			fieldHashtable = new Hashtable();
			_fieldsCustomProperties.Add("FkBildirimId_", fieldHashtable);
			fieldHashtable = new Hashtable();
		...
		protected override void InitClass(bool obeyWeakRelations)
		{
			...
			_columnBildirimTuruDurum = GeneralUtils.CreateTypedDataTableColumn("BildirimTuruDurum", @"BildirimTuruDurum", typeof(System.Boolean), this.Columns);
			...
			_columnFkBildirimId_ = GeneralUtils.CreateTypedDataTableColumn("FkBildirimId_", @"FkBildirimId", typeof(System.Int64), this.Columns);
		...
		private void InitMembers()
		{
			...
			_columnBildirimTuruDurum = this.Columns["BildirimTuruDurum"];
			...
			_columnFkBildirimId_ = this.Columns["FkBildirimId_"];
		...
		{
			get { return ListAtamaTypedList.CustomProperties;}
		}
		...
		{
			get { return ListAtamaTypedList.FieldsCustomProperties;}
		}
		...
		/// <summary>Returns the column object belonging to the TypedList field BildirimTuruDurum</summary>
		internal DataColumn BildirimTuruDurumColumn 
		{
			get { return _columnBildirimTuruDurum; }
		}
		...
		/// <summary>Returns the column object belonging to the TypedList field FkBildirimId_</summary>
		internal DataColumn FkBildirimId_Column 
		{
			get { return _columnFkBildirimId_; }
		}
	...
	/// <summary>Typed datarow for the typed datatable ListAtama</summary>
	public partial class ListAtamaRow : DataRow
		// __LLBLGENPRO_USER_CODE_REGION_START AdditionalInterfacesRow
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		#region Class Member Declarations
		private ListAtamaTypedList	_parent;
		#endregion

		/// <summary>CTor</summary>
		/// <param name="rowBuilder">Row builder object to use when building this row</param>
		protected internal ListAtamaRow(DataRowBuilder rowBuilder) : base(rowBuilder) 
		{
			_parent = ((ListAtamaTypedList)(this.Table));
		}
		...
		/// <summary>Gets / sets the value of the TypedList field BildirimTuruDurum<br/><br/>
		/// </summary>
		/// <remarks>Mapped on: BildirimTuru.BildirimTuruDurum</remarks>
		public System.Boolean BildirimTuruDurum 
		{
			get { return IsBildirimTuruDurumNull() ? (System.Boolean)TypeDefaultValue.GetDefaultValue(typeof(System.Boolean)) : (System.Boolean)this[_parent.BildirimTuruDurumColumn]; }
			set { this[_parent.BildirimTuruDurumColumn] = value; }
		}

		/// <summary>Returns true if the TypedList field BildirimTuruDurum is NULL, false otherwise.</summary>
		public bool IsBildirimTuruDurumNull() 
		{
			return IsNull(_parent.BildirimTuruDurumColumn);
		}

		/// <summary>Sets the TypedList field BildirimTuruDurum to NULL. Not recommended; a typed list should be used as a readonly object.</summary>
    	public void SetBildirimTuruDurumNull() 
		{
			this[_parent.BildirimTuruDurumColumn] = System.Convert.DBNull;
		}
		...
		/// </summary>
		/// <remarks>Mapped on: BildirimAtamaGrup.FkBildirimId</remarks>
		...
		/// <summary>Gets / sets the value of the TypedList field FkBildirimId_<br/><br/>
		/// </summary>
		/// <remarks>Mapped on: BildirimAtamaKullanici.FkBildirimId</remarks>
		public System.Int64 FkBildirimId_ 
		{
			get { return IsFkBildirimId_Null() ? (System.Int64)TypeDefaultValue.GetDefaultValue(typeof(System.Int64)) : (System.Int64)this[_parent.FkBildirimId_Column]; }
			set { this[_parent.FkBildirimId_Column] = value; }
		}

		/// <summary>Returns true if the TypedList field FkBildirimId_ is NULL, false otherwise.</summary>
		public bool IsFkBildirimId_Null() 
		{
			return IsNull(_parent.FkBildirimId_Column);
		}

		/// <summary>Sets the TypedList field FkBildirimId_ to NULL. Not recommended; a typed list should be used as a readonly object.</summary>
    	public void SetFkBildirimId_Null() 
		{
			this[_parent.FkBildirimId_Column] = System.Convert.DBNull;
		}
		/// <summary>Gets / sets the value of the TypedList field FkGrupId<br/><br/>
		/// </summary>
		/// <remarks>Mapped on: BildirimAtamaGrup.FkGrupId</remarks>
