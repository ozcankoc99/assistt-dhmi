...
namespace dhmi.TypedListClasses
{
	...
	/// <summary>Typed datatable for the list 'ListBildirim'.<br/><br/></summary>
	[Serializable, System.ComponentModel.DesignerCategory("Code")]
	[ToolboxItem(true)]
	[DesignTimeVisible(true)]
	public partial class ListBildirimTypedList : TypedListBase<ListBildirimRow>
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private DataColumn _columnVatandasVergiNo;
		...
		static ListBildirimTypedList()
		{
			SetupCustomPropertyHashtables();
		}
		
		/// <summary>CTor</summary>
		public ListBildirimTypedList():base("ListBildirim")
		{
			InitClass(false);
		}
		...
		public ListBildirimTypedList(bool obeyWeakRelations):base("ListBildirim")
		{
		...
		protected ListBildirimTypedList(SerializationInfo info, StreamingContext context):base(info, context)
		{
			InitMembers();
		}
#endif		
		...
		{
			ListBildirimTypedList cloneToReturn = ((ListBildirimTypedList)(base.Clone()));
		...
		{
			return new ListBildirimRow(rowBuilder);
		}
		...
		protected override IEntityFields BuildResultset()
		{
			...
			toReturn.DefineField(BildirimFields.BildirimGeriYapildiMi, 9, "BildirimGeriYapildiMi", "", AggregateFunction.None);
			...
			toReturn.DefineField(BildirimGeriDonuFields.BildirimGeriDonusAd, 26, "BildirimGeriDonusAd", "", AggregateFunction.None);
			toReturn.DefineField(BildirimSonucFields.BildirimSonucAd, 27, "BildirimSonucAd", "", AggregateFunction.None);
			toReturn.DefineField(BildirimTuruFields.BildirimTuruAd, 28, "BildirimTuruAd", "", AggregateFunction.None);
			toReturn.DefineField(CagriTipiFields.CagriTipiAd, 29, "CagriTipiAd", "", AggregateFunction.None);
			toReturn.DefineField(KullaniciFields.KullaniciAdSoyad, 30, "KullaniciAdSoyad", "", AggregateFunction.None);
			toReturn.DefineField(VatandaFields.VatandasTel1, 31, "VatandasTel1", "", AggregateFunction.None);
			toReturn.DefineField(VatandaFields.VatandasTcNo, 32, "VatandasTcNo", "", AggregateFunction.None);
			toReturn.DefineField(VatandaFields.VatandasAdSoyad, 33, "VatandasAdSoyad", "", AggregateFunction.None);
			toReturn.DefineField(BildirimTuruFields.BildirimTuruDurum, 34, "BildirimTuruDurum", "", AggregateFunction.None);
			toReturn.DefineField(KullaniciFields.KullaniciId, 35, "KullaniciId", "", AggregateFunction.None);
			toReturn.DefineField(AltKonuFields.FkKonuId, 36, "FkKonuId", "", AggregateFunction.None);
			toReturn.DefineField(VatandaFields.VatandasId, 37, "VatandasId", "", AggregateFunction.None);
			toReturn.DefineField(VatandaFields.VatandasPasaportNo, 38, "VatandasPasaportNo", "", AggregateFunction.None);
			toReturn.DefineField(BildirimFields.BildirimVatandasKarar, 39, "BildirimVatandasKarar", "", AggregateFunction.None);
			toReturn.DefineField(VatandaFields.VatandasVergiNo, 40, "VatandasVergiNo", "", AggregateFunction.None);
		...
		protected override void InitClass(bool obeyWeakRelations)
		{
			...
			_columnVatandasVergiNo = GeneralUtils.CreateTypedDataTableColumn("VatandasVergiNo", @"VatandasVergiNo", typeof(System.String), this.Columns);
		...
		private void InitMembers()
		{
			...
			_columnVatandasVergiNo = this.Columns["VatandasVergiNo"];
		...
		{
			return new ListBildirimTypedList();
		}
#endif
		...
		{
			get { return ListBildirimTypedList.CustomProperties;}
		}
		...
		{
			get { return ListBildirimTypedList.FieldsCustomProperties;}
		}
		...
		/// <summary>Returns the column object belonging to the TypedList field VatandasVergiNo</summary>
		internal DataColumn VatandasVergiNoColumn 
		{
			get { return _columnVatandasVergiNo; }
		}
	...
	/// <summary>Typed datarow for the typed datatable ListBildirim</summary>
	public partial class ListBildirimRow : DataRow
		// __LLBLGENPRO_USER_CODE_REGION_START AdditionalInterfacesRow
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		#region Class Member Declarations
		private ListBildirimTypedList	_parent;
		#endregion

		/// <summary>CTor</summary>
		/// <param name="rowBuilder">Row builder object to use when building this row</param>
		protected internal ListBildirimRow(DataRowBuilder rowBuilder) : base(rowBuilder) 
		{
			_parent = ((ListBildirimTypedList)(this.Table));
		}
		...
		/// <summary>Gets / sets the value of the TypedList field VatandasVergiNo<br/><br/>
		/// </summary>
		/// <remarks>Mapped on: Vatanda.VatandasVergiNo</remarks>
		public System.String VatandasVergiNo 
		{
			get { return IsVatandasVergiNoNull() ? (System.String)TypeDefaultValue.GetDefaultValue(typeof(System.String)) : (System.String)this[_parent.VatandasVergiNoColumn]; }
			set { this[_parent.VatandasVergiNoColumn] = value; }
		}

		/// <summary>Returns true if the TypedList field VatandasVergiNo is NULL, false otherwise.</summary>
		public bool IsVatandasVergiNoNull() 
		{
			return IsNull(_parent.VatandasVergiNoColumn);
		}

		/// <summary>Sets the TypedList field VatandasVergiNo to NULL. Not recommended; a typed list should be used as a readonly object.</summary>
    	public void SetVatandasVergiNoNull() 
		{
			this[_parent.VatandasVergiNoColumn] = System.Convert.DBNull;
		}
		#endregion
