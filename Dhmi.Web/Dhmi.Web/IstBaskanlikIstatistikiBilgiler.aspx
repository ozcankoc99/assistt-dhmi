<%@ Page Title="DHMİ İletişim Merkezi - Başkanlık İstatistik Bilgileri" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="IstBaskanlikIstatistikiBilgiler.aspx.cs" Inherits="Dhmi.Web.IstBaskanlikIstatistikiBilgiler" %>
                    ...
                    <ContentCollection>
                        <dx:ContentControl ID="ContentControl1" runat="server">
                            <asp:Panel ID="pnl_yeni_kayit" runat="server" Width="1325" Height="440">                               
                                <table>
                                    <tr>
                                        <td width="1620" align="left">
                                            <dx:WebChartControl ID="WebChartControl1" runat="server" Width="870" Height="440" ClientInstanceName="chart1">
                                            </dx:WebChartControl>                                            
                                        </td>
                                        <td width="500" align="left">
                                            <table>                                               
                                                <tr>
                                                    <td>
                                                        <asp:Panel ID="panel2" runat="server" Width="428px" Height="436px" BorderColor="Maroon" BorderWidth="1" BorderStyle="Dotted">
                                                        <br />                                                        
                                                        <table>
                                                            <tr>
