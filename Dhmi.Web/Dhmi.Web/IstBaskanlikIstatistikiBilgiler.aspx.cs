...
namespace Dhmi.Web
{
    public partial class IstBaskanlikIstatistikiBilgiler : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (IsPostBack != true)
            {
                ...
                title.Text = "Başkanlık İşlem Sayıları";
                ...
                ExpAlt2.AddWithAnd(AltAltMenuFields.AltAltMenuAd == "Başkanlık İstatistik Bilgileri");
