<%@ Page Title="DHMİ İletişim Merkezi - Bildirim Durumu İstatistik Bilgileri" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="IstBilDurumIstatistikiBilgiler.aspx.cs" Inherits="Dhmi.Web.IstBilDurumIstatistikiBilgiler" %>
                    ...
                    <ContentCollection>
                        <dx:ContentControl ID="ContentControl1" runat="server">
                            <asp:Panel ID="pnl_yeni_kayit" runat="server" Width="1325" Height="440">                               
                                <table>
                                    <tr>
                                        <td width="920" align="left">
                                            <dx:WebChartControl ID="WebChartControl1" runat="server" Width="820" Height="440" ClientInstanceName="chart1">
                                            </dx:WebChartControl>                                            
                                        </td>
