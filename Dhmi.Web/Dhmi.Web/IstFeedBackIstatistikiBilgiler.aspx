<%@ Page Title="DHMİ İletişim Merkezi - Feedback İstatistik Bilgileri" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="IstFeedBackIstatistikiBilgiler.aspx.cs" Inherits="Dhmi.Web.IstFeedBackIstatistikiBilgiler" %>
                                ...
                                <table>
                                    <tr>
                                        <td width="920" align="left">
                                            <dx:WebChartControl ID="WebChartControl1" runat="server" Width="720" Height="420" ClientInstanceName="chart1">
                                            </dx:WebChartControl>                                            
                                        </td>
