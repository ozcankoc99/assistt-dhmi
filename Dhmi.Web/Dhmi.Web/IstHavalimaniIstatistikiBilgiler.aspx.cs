...
namespace Dhmi.Web
{
    public partial class IstHavalimaniIstatistikiBilgiler : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (IsPostBack != true)
            {
                ...
                title.Text = "Havalimanı İşlem Sayıları";
                ...
                ExpAlt2.AddWithAnd(AltAltMenuFields.AltAltMenuAd == "Havalimanı İstatistik Bilgileri");
            ...
            IPredicateExpression query = new PredicateExpression();
            query.Add(new FieldLikePredicate(HavalimaniFields.HavalimaniAd, "%havalimanı%"));
            ...
            CollHav.GetMulti(query,0,sorthav);
            ...
            for (int i = 0; i < CollHav.Count; i++)
            {
                ...
                ExpBil.AddWithAnd(BildirimFields.BildirimHavalimani == CollHav[i].HavalimaniAd);
                ...
                if (CollBil.Count > 0)
                {
                    ...
                    EntKay.IstatistikAd = CollHav[i].HavalimaniAd;
