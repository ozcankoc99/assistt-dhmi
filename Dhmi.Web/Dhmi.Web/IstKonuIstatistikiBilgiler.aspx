<%@ Page Title="DHMİ İletişim Merkezi - Konu İstatistik Bilgileri" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="IstKonuIstatistikiBilgiler.aspx.cs" Inherits="Dhmi.Web.IstKonuIstatistikiBilgiler" %>
                ...
                <dx:TabPage Text="Saatlik İstatistiki Bilgiler">
                    <ContentCollection>
                        <dx:ContentControl ID="ContentControl1" runat="server">
                            <asp:Panel ID="pnl_yeni_kayit" runat="server" Width="3632" Height="915">                               
                                <table>
                                    <tr>
                                        <td width="3320" align="left">
                                            <dx:WebChartControl ID="WebChartControl1" runat="server" Width="3155" Height="930" ClientInstanceName="chart1">
                                            </dx:WebChartControl>                                            
                                        </td>                                        
