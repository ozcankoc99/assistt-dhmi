...
namespace Dhmi.Web
{
    public partial class IstKonuIstatistikiBilgiler : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (IsPostBack != true)
            {
                ...
                title.Text = "Bildirim Konu Tür Sayıları";
                ...
                ExpAlt2.AddWithAnd(AltAltMenuFields.AltAltMenuAd == "Konu İstatistik Bilgileri");
            ...
            AltKonuCollection CollHav = new AltKonuCollection();
            ISortExpression sorthav = new SortExpression();
            sorthav.Add(new SortClause(AltKonuFields.AltKonuAd, SortOperator.Ascending));
            ...
            for (int i = 0; i < CollHav.Count; i++)
            {
                ...
                ExpBil.AddWithAnd(BildirimFields.FkAltKonuId == CollHav[i].AltKonuId);
                ...
                if (CollBil.Count > 0)
                {
                    ...
                    EntKay.IstatistikAd = CollHav[i].AltKonuAd;
