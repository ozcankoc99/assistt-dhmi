<%@ Page Title="DHMİ İletişim Merkezi - Kullanıcı (İM) İstatistik Bilgileri" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="IstKullaniciIMIstatistikiBilgiler.aspx.cs" Inherits="Dhmi.Web.IstKullaniciIMIstatistikiBilgiler" %>
                ...
                <dx:TabPage Text="Saatlik İstatistiki Bilgiler">
                    <ContentCollection>
                        <dx:ContentControl ID="ContentControl1" runat="server">
                            <asp:Panel ID="pnl_yeni_kayit" runat="server" Width="1732" Height="715">                               
                                <table>
                                    <tr>
                                        <td width="2020" align="left">
                                            <dx:WebChartControl ID="WebChartControl1" runat="server" Width="1255" Height="700" ClientInstanceName="chart1">
                                            </dx:WebChartControl>                                            
                                        </td>
