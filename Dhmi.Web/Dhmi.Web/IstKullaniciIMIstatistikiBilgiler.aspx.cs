...
namespace Dhmi.Web
{
    public partial class IstKullaniciIMIstatistikiBilgiler : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (cookie != null && cookieYetki != null)
            {
                ...
                if (yetki == "Admin" || yetki == "Takım Lideri" || yetki == "Kurum Sistem Yöneticisi")
                {
            ...
            if (IsPostBack != true)
            {
                ...
                ExpAlt2.AddWithAnd(AltAltMenuFields.AltAltMenuAd == "Kullanıcı (İM) İstatistik Bilgileri");
            ...
            ExpYetki.AddWithAnd(YetkiFields.YetkiAd == "İletişim Merkezi Temsilcisi");
            ...
            ExpTur.AddWithAnd(KullaniciFields.FkYetkiId == CollYetki[0].YetkiId);
            ...
            for (int i = 0; i < CollTur.Count; i++)
            {
                ...
                ExpBil.AddWithAnd(BildirimFields.FkKullaniciId == CollTur[i].KullaniciId);
