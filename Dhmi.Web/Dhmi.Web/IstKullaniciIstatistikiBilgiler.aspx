<%@ Page Title="DHMİ İletişim Merkezi - Kullanıcı (Back) İstatistik Bilgileri" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="IstKullaniciIstatistikiBilgiler.aspx.cs" Inherits="Dhmi.Web.IstKullaniciIstatistikiBilgiler" %>
                ...
                <dx:TabPage Text="Saatlik İstatistiki Bilgiler">
                    <ContentCollection>
                        <dx:ContentControl ID="ContentControl1" runat="server">
                            <asp:Panel ID="pnl_yeni_kayit" runat="server" Width="2082" Height="535">                               
                                <table>
                                    <tr>
                                        <td width="1820" align="left">
                                            <dx:WebChartControl ID="WebChartControl1" runat="server" Width="1620" Height="550" ClientInstanceName="chart1">
                                            </dx:WebChartControl>                                            
                                        </td>
