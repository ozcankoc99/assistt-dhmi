...
namespace Dhmi.Web
{
    public partial class IstKullaniciIstatistikiBilgiler : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (IsPostBack != true)
            {
                ...
                title.Text = "Kullanıcı İşlem Sayıları";
                ...
                ExpAlt2.AddWithAnd(AltAltMenuFields.AltAltMenuAd == "Kullanıcı (Back) İstatistik Bilgileri");
            ...
            KullaniciCollection CollTur = new KullaniciCollection();
            IPredicateExpression ExpTur = new PredicateExpression();
            ISortExpression sorttur = new SortExpression();
            ExpTur.AddWithAnd(KullaniciFields.KullaniciDurum == true);
            sorttur.Add(new SortClause(KullaniciFields.KullaniciAdSoyad, SortOperator.Ascending));
            ...
            for (int i = 0; i < CollTur.Count; i++)
            {
                ...
                ExpBil.AddWithAnd(BildirimFields.BildirimKimBitirdi == CollTur[i].KullaniciId);
                ...
                if (CollBil.Count > 0)
                {
                    ...
                    EntKay.IstatistikAd = CollTur[i].KullaniciAdSoyad;
            ...
            var q = (from ist in metaData.Istatistik
                     join k in metaData.Kullanici on ist.IstatistikAd equals k.KullaniciAdSoyad
                     where ist.FkKullaniciId == Convert.ToInt16(Session["kullanici_var_mi"].ToString()) && k.FkGorevId == 7
                     select ist);
            ...
            WebChartControl1.DataSource = q.ToList();            
