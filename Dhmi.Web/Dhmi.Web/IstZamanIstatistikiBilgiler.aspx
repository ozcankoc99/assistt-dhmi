<%@ Page Title="DHMİ İletişim Merkezi - Zaman Bazlı İstatistik Bilgileri" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeBehind="IstZamanIstatistikiBilgiler.aspx.cs" Inherits="Dhmi.Web.IstZamanIstatistikiBilgiler" %>
                    ...
                    <ContentCollection>
                        <dx:ContentControl ID="ContentControl1" runat="server">
                            <asp:Panel ID="pnl_yeni_kayit" runat="server" Width="1325" Height="440">                               
                                <table>
                                    <tr>
                                        <td width="1070" align="left">
                                            <dx:WebChartControl ID="WebChartControl1" runat="server" Width="870" Height="440" ClientInstanceName="chart1" ToolTipEnabled="False">
                                            </dx:WebChartControl>                                            
                                        </td>
