...
namespace Dhmi.Web
{
    public partial class IstZamanIstatistikiBilgiler : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (IsPostBack != true)
            {
                ...
                ExpAlt2.AddWithAnd(AltAltMenuFields.AltAltMenuAd == "Zaman Bazlı İstatistik Bilgileri");
            ...
            {
                ExpVat.AddWithAnd(VatandaFields.VatandasIslemTarih >= Convert.ToDateTime(txt_bas_tarihi.Text));
                ExpVat.AddWithAnd(VatandaFields.VatandasIslemTarih <= Convert.ToDateTime(txt_bit_tarihi.Text));
            }
            ...
            if (Session["icerden_gel_saat"] != null)
            {
                ...
                if (giris == 1)
                {
                    ExpVat.AddWithAnd(VatandaFields.VatandasIslemTarih >= bas);
                    ExpVat.AddWithAnd(VatandaFields.VatandasIslemTarih <= bit);
                }
            }
            ...
            if (CollVat.Count > 0)
            {
                int gercek = 0, gercek_yabanci = 0, tuzel = 0;

                for (int i = 0; i < CollVat.Count; i++)
                {
                    if (CollVat[i].VatandasTur == "Gerçek Kişi") 
                    {
                        gercek = gercek + 1;
                    }

                    else if (CollVat[i].VatandasTur == "Gerçek Kişi (Yabancı)")
                    {
                        gercek_yabanci = gercek_yabanci + 1;
                    }
                ...
                if (gercek > 0) 
                {
                    ...
                    EntKay.IstatistikAd = "Vatandaş (Gerçek Kişi)";
                    EntKay.IstatistikAlt = gercek.ToString() + " ADET";
                    EntKay.IstatistikSol = gercek;
                    EntKay.Save();
                }
                ...
                if (gercek_yabanci > 0)
                {
                    ...
                    EntKay2.IstatistikAd = "Vatandaş (Gerçek Kişi (Yabancı))";
                    EntKay2.IstatistikAlt = gercek_yabanci.ToString() + " ADET";
                    EntKay2.IstatistikSol = gercek_yabanci;
                    EntKay2.Save();
                }
                ...
                if (tuzel > 0)
                {
                    ...
                    EntKay3.IstatistikAd = "Tüzel Kişi";
                    EntKay3.IstatistikAlt = tuzel.ToString() + " ADET";
                    EntKay3.IstatistikSol = tuzel;
                    EntKay3.Save();
                }                
            }
            ...
            if (CollBil.Count > 0)
            {
                IstatistikEntity EntKay = new IstatistikEntity();
                EntKay.FkKullaniciId = Convert.ToInt16(Session["kullanici_var_mi"].ToString());
                EntKay.IstatistikAd = "Çağrı Kayıt Sayısı";
        ...
        protected void btn_kaydet_Click(object sender, EventArgs e)
        {
            ...
            VatandaCollection CollVat = new VatandaCollection();
            IPredicateExpression ExpVat = new PredicateExpression();
            ExpVat.AddWithAnd(VatandaFields.VatandasCinsiyet != "---");
            ExpVat.AddWithAnd(VatandaFields.VatandasIslemTarih >= Convert.ToDateTime(txt_bas_tarihi.Text));
            ExpVat.AddWithAnd(VatandaFields.VatandasIslemTarih <= Convert.ToDateTime(txt_bit_tarihi.Text));
            CollVat.GetMulti(ExpVat);
