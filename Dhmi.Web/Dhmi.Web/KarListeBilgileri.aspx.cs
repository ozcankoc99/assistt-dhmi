...
namespace Dhmi.Web
{
    public partial class KarListeBilgileri : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (IsPostBack != true)
            {
                ...
                ExpAlt1.AddWithAnd(AltMenuFields.AltMenuAd == "Kara Liste Bilgileri");
                ...
                ExpAlt2.AddWithAnd(AltAltMenuFields.AltAltMenuAd == "Kara Liste Bilgileri");
        ...
        {
            txtUserName.Text = grid_vip_sil.GetSelectedFieldValues("KaraListeId")[0].ToString();
        ...
        protected void btn_iptal_et_Click(object sender, EventArgs e)
        {
            ...
            ExpVip.AddWithAnd(KaraListeFields.KaraListeId == Convert.ToInt64(txtUserName.Text));
            ...
            if (CollVip[0].KaraListeDurum == false)
            {
                string CloseWindow;
            ...
            {
                CollVip[0].KaraListeDurum = false;
                CollVip[0].KaraListeIptalTarihi = DateTime.Now;
                CollVip[0].KaraListeIptalEdenKullanici = CollKul[0].KullaniciAdSoyad;
                CollVip[0].Save();
                ...
                EntAr.VatandasArsivAciklama = CollKul[0].KullaniciAdSoyad + " tarafından Kara Liste kaydı iptal edildi.";
                EntAr.Save();
            }
        }
        ...
        protected void btn_kaydet_Click(object sender, EventArgs e)
        {
            ...
            {
                string CloseWindow;
                CloseWindow = "alert('Kara Liste kaydı yapabilmek için lütfen geçerli bir vatandaş seçiniz...')";
                ScriptManager.RegisterStartupScript(this, this.GetType(), "CloseWindow", CloseWindow, true);
            }
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            KaraListeCollection CollVip = new KaraListeCollection();
                            IPredicateExpression ExpVip = new PredicateExpression();
                            ExpVip.AddWithAnd(KaraListeFields.FkVatandasId == Convert.ToInt64(Session["vat_id"].ToString()));
                            ...
                            {
                                VipListeCollection CollTi = new VipListeCollection();
                                IPredicateExpression ExpTi = new PredicateExpression();
                                ExpTi.AddWithAnd(VipListeFields.FkVatandasId == Convert.ToInt64(Session["vat_id"].ToString()));
                                ExpTi.AddWithAnd(VipListeFields.VipListeDurum == true);
                                CollTi.GetMulti(ExpTi);
                                ...
                                else
                                {
                                    ...
                                    KaraListeEntity EntKay = new KaraListeEntity();
                                    EntKay.KaraListeIslemYapan = CollKul12[0].KullaniciAdSoyad;
                                    EntKay.FkVatandasId = Convert.ToInt64(Session["vat_id"].ToString());
                                    EntKay.KaraListeAciklama = txt_aciklama.Text;
                                    EntKay.KaraListeBslTarihSaat = Convert.ToDateTime(txt_bas_tarihi.Text + " " + cb_bas_saat.Text);
                                    EntKay.KaraListeBtsTarihSaat = Convert.ToDateTime(txt_bit_tarihi.Text + " " + cb_bit_saat.Text);
                                    EntKay.KaraListeDurum = true;
                                    EntKay.KaraListeIslemTarih = DateTime.Now;
                                    EntKay.Save();
                                    ...
                                    EntAr.VatandasArsivIslemTarih = DateTime.Now;
                                    EntAr.VatandasArsivAciklama = CollKul[0].KullaniciAdSoyad + " tarafından Kara Liste kaydı yapıldı.";
                                    EntAr.Save();
