namespace Dhmi.Web
{
    ...
    public partial class YonSistemLogBilgileri : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ListLogTypedList borc_list = new ListLogTypedList();
            ISortExpression sort = new SortExpression();
            sort.Add(new SortClause(LogFields.LogTarih, SortOperator.Descending));
            borc_list.Fill(0, sort);

            grid_log.DataSource = borc_list;
            grid_log.DataBind();
            ...
            grid_log_export.PageHeader.Center = Environment.NewLine + "  " + Environment.NewLine + "  " + Environment.NewLine + "   " + Environment.NewLine + "DEVLET HAVA MEYDANLARI İŞLETMESİ GENEL MÜDÜRLÜĞÜ (DHMİ)" + Environment.NewLine + "İLETİŞİM MERKEZİ SİSTEMİ" + Environment.NewLine + "SİSTEM LOG BİLGİLERİ" + Environment.NewLine + "  " + Environment.NewLine + "  ";
            grid_log_export.PageFooter.Center = System.DateTime.Now.ToString("dd.MM.yyyy");
            ...
            grid_log.SettingsPager.PageSize = Convert.ToInt32(CollParam[0].ParametreDeger);
            ...
            if (IsPostBack != true)
            {
                ...
                ExpAlt2.AddWithAnd(AltAltMenuFields.AltAltMenuAd == "Sistem Log Bilgileri");
        ...
        {
            string ad = "sistem_log_bilgileri_pdf_" + DateTime.Now.ToShortDateString();
            grid_log_export.WritePdfToResponse(ad);
        }

        protected void btnXlsExport_Click(object sender, EventArgs e)
        {
            string ad = "sistem_log_bilgileri_xls_" + DateTime.Now.ToShortDateString();
            grid_log_export.WriteXlsToResponse(ad);
        }

        protected void btnRtfExport_Click(object sender, EventArgs e)
        {
            string ad = "sistem_log_bilgileri_rtf_" + DateTime.Now.ToShortDateString();
            grid_log_export.WriteRtfToResponse(ad);
        }

        protected void grid_log_PageSizeChanged(object sender, EventArgs e)
        {
            ParametreCollection CollParam = new ParametreCollection();
            IPredicateExpression ExpParam = new PredicateExpression();
            ExpParam.AddWithAnd(ParametreFields.ParametreAd == "Rapor Sayı");
            ...
            CollParam[0].ParametreDeger = grid_log.SettingsPager.PageSize.ToString();
            CollParam[0].Save();
        }
    }
}